  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        $sql = "SELECT * FROM writeboard WHERE name = '".$_SESSION['username']."'";   
        ...
        while($row = mysqli_fetch_array($result)){
         ...
         echo '<a href=./exchange.php?exc1='.$row['idx'].'&money='.$row['money'].'&exMoney='.$_GET['exMoney'].'&exidx='.$_GET['exidx'].'><input type="button" name= buy value = 선택></a>';
        echo '</div>' ;
        echo '</div>' ;
        echo '</div>' ;
